...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col transition-colors">
      {/* Header */}
      <header className="bg-somali-blue p-6 rounded-b-3xl shadow-lg relative z-10">
      ...
      {/* Main Menu */}
      <main className="flex-1 p-6 space-y-4 -mt-2">
        
        {/* Admin Button */}
        {profile?.role === 'admin' && (
          <Card className="bg-gray-800 dark:bg-gray-800 text-white transform hover:scale-105 transition-transform cursor-pointer border-l-8 border-gray-600">
        ...
        <Card className="transform hover:scale-105 transition-transform cursor-pointer border-l-8 border-yellow-400" >
        ...
        <Card className="transform hover:scale-105 transition-transform cursor-pointer border-l-8 border-green-500">
        ...
        <Card className="transform hover:scale-105 transition-transform cursor-pointer border-l-8 border-purple-500">
